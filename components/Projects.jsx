const featuredProjects = [
    ...
    {
        title: 'Advents',
        description: 'Full-stack car-related platform with authentication, CRUD operations, and dynamic UI. Comprehensive solution for automotive needs and listings.',
