      ...
      <div className="container">
        ...
        <div className="contact-grid">
          <div className="contact-info">
            ...
            <a href="https://www.linkedin.com/in/kamran-ali-abbasi-b767a0280/" target="_blank" rel="noopener noreferrer" className="contact-item">
              <div className="contact-item-icon">
              ...
              <div>
                ...
                <p className="contact-item-value">Kamran Ali Abbasi</p>
              </div>
            </a>

            <a href="https://github.com/kamranabbasi3404" target="_blank" rel="noopener noreferrer" className="contact-item">
              <div className="contact-item-icon">
                <svg viewBox="0 0 24 24" fill="currentColor">
              ...
              <div>
                ...
                <p className="contact-item-value">github.com/kamranabbasi3404</p>
              </div>
            </a>
          </div>
          ...
          <form ref={formRef} className="contact-form" onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <input type="text" id="contact-name" name="from_name" placeholder="Your name" required />
            </div>
            <div className="form-group">
              <label htmlFor="contact-email">Email</label>
              <input type="email" id="contact-email" name="from_email" placeholder="Your email" required />
            </div>
            <div className="form-group">
